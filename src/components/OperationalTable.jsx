...
export default function OperationalTable({
  ...
  editingStoreId, storeEditData, setStoreEditData, saveStoreEdit, startEditingStore, deleteStore, setEditingStoreId, 
  generateStoreWhatsAppLink, generateClientWhatsAppLink, handleStoreChange, openHistoryModal, openClientFile, globalGrowth, formatCurrency
}) {

  // Recebe as lojas já filtradas perfeitamente do App.jsx
